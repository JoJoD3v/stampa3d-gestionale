...
.drop-zone.dragover { border-color: #023059; background: #eef1f8; }
...
.file-list-item.existing { background: #e8f0fe; }
.file-list-item.existing svg { opacity: .6; color: #023059; }
.file-list-item .file-ext {
    font-size: .7rem; font-weight: 700; background: #023059; color: #fff;
...
.section-divider { font-size: .78rem; font-weight: 700; color: #6b7280; text-transform: uppercase; letter-spacing: .05em; margin: 1rem 0 .5rem; }
</style>
@endpush
...
<div class="page-header">
    ...
    <div style="display:flex;gap:.5rem;">
        <a href="{{ route('backend.projects.show', $project) }}" class="btn btn-secondary">
...
<form method="POST" action="{{ route('backend.projects.update', $project) }}" enctype="multipart/form-data" id="projectForm">
    @csrf
    @method('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="filament_type" name="filament_type"
                               ...
                               value="{{ old('filament_type', $project->filament_type) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="filament_grams" name="filament_grams"
                               ...
                               value="{{ old('filament_grams', $project->filament_grams) }}" min="1" required>
                        ...
                        <div class="time-row">
                            <div class="form-group" style="margin-bottom:0">
                                ...
                                <input type="number" id="print_hours" name="print_hours"
                                       ...
                                       value="{{ old('print_hours', $project->print_hours) }}" min="0" required>
                            </div>
                            <div class="form-group" style="margin-bottom:0">
                                ...
                                <input type="number" id="print_minutes" name="print_minutes"
                                       ...
                                       value="{{ old('print_minutes', $project->print_minutes) }}" min="0" max="59" required>
                            </div>
                        </div>
                        ...
                        <div class="time-row">
                            <div class="form-group" style="margin-bottom:0">
                                ...
                                <input type="number" id="height_cm" name="height_cm" step="0.01"
                                       ...
                                       value="{{ old('height_cm', $project->height_cm) }}" placeholder="0.00" min="0">
                            </div>
                            <div class="form-group" style="margin-bottom:0">
                                ...
                                <input type="number" id="width_cm" name="width_cm" step="0.01"
                                       ...
                                       value="{{ old('width_cm', $project->width_cm) }}" placeholder="0.00" min="0">
                            </div>
                            <div class="form-group" style="margin-bottom:0">
                                ...
                                <input type="number" id="depth_cm" name="depth_cm" step="0.01"
                                       ...
                                       value="{{ old('depth_cm', $project->depth_cm) }}" placeholder="0.00" min="0">
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @if($project->photo_url)
                        <div class="photo-preview" style="margin-bottom:.75rem;">
                            <p style="font-size:.8rem;color:#6b7280;margin-bottom:.4rem;">Foto attuale:</p>
                            <img src="{{ $project->photo_url }}" alt="{{ $project->name }}">
                        </div>
                    @endif
                    <div class="form-group" style="margin-bottom:0">
                        <label class="form-label" for="photo">{{ $project->photo ? 'Sostituisci foto' : 'Carica foto' }} (max 5 MB)</label>
                        <input type="file" id="photo" name="photo" accept="image/*"
                               class="form-control @error('photo') is-invalid @enderror"
                               onchange="previewPhoto(this)">
                        @error('photo')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        <div class="photo-preview" id="photoPreview" style="display:none;">
                            <p style="font-size:.8rem;color:#6b7280;margin:.5rem 0 .3rem;">Nuova foto:</p>
            ...
            <div class="card" style="flex:1">
                ...
                <div class="card-body">
                    ...
                    @if($project->files->isNotEmpty())
                        <div class="section-divider">File già caricati</div>
                        <div class="file-list">
                            @foreach($project->files as $file)
                            <div class="file-list-item existing">
                        ...
                        <div class="section-divider" style="margin-top:1.2rem;">Aggiungi nuovi file</div>
                    @endif
                    ...
                    <input type="file" id="filesInput" name="files[]" multiple style="display:none"
    ...
    <div style="margin-top:1.5rem;display:flex;gap:.75rem;justify-content:flex-end;">
        <a href="{{ route('backend.projects.show', $project) }}" class="btn btn-secondary">Annulla</a>
...
function removeFile(index) {
    ...
    [...filesDT.files].forEach((f, i) => { if (i !== index) newDT.items.add(f); });
    filesDT = newDT;
    fileInput.files = filesDT.files;
    renderFileList();
}
